...
export const loop = ErrorMapper.wrapLoop(() => {
  ...
  RoleHarvester.model = [MOVE, MOVE, MOVE, WORK, WORK, WORK, CARRY, CARRY]

  RoleUpgrader.active = true
  RoleUpgrader.total = 4
  RoleUpgrader.source = 1
  RoleUpgrader.model = [MOVE, MOVE, MOVE, WORK, WORK, WORK, CARRY, CARRY]

  RoleBuilder.active = true
  RoleBuilder.total = 3
  RoleBuilder.source = 0
  RoleBuilder.model = [MOVE, MOVE, MOVE, WORK, WORK, WORK, CARRY, CARRY]

  RoleRepairer.active = true
  RoleRepairer.total = 1
  RoleRepairer.source = 0
  RoleRepairer.model = [MOVE, MOVE, MOVE, WORK, WORK, WORK, CARRY, CARRY]
